...
<% 
	...
	/* 
	request 객체
	Tomcat 이 가지고 있는 내장개체 (웹 프로젝트가 톰켓 서버 설정을 가지고 있어야)
	
	request 객체(요청객체)
	1.요청 페이지당 한개의 request 생성
	2.클라이언트의 정보를 read 가능
	3.클라이언트 정보(입력값, 기본정보 : 브라우져 버젼)
...
<body>
	...
	실경로 (물리적경로) : C:\FrontendBackend\WebJSP\JSPLab\WebJSP\WebContent\Ex04_request.jsp
	-->
</body>
</html>